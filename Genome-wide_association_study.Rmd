...
We carried out genomewide association studies (GWAS) between *Arabidopsis thaliana* genotypes and flowering time phenotypes (FT16). GWAS were performed with 6 different methods: sparse lfmm, bslmm, lasso, ridge lfmm, cate and sva.
